const config = {
  ...
  accounts: [
    {
      username: "17502953925", //用户名
      password: "ITXMIN2002", //密码
      openId: "ooru94sKhSJiFU-krjUq7fNyE-2o", //微信小程序抓包openid(可选)
      unionId: "oHY-uwUM3AIYZeyTlbbFl8F3l4RI", //微信小程序抓包unionId(可选)
      sign: true, //是否自动签到
      reSign: false, //是否重新签到
